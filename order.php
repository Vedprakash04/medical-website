...
<div class="container-fluid1 mt-3 ">
  <h3 style="color: white; padding:`5px ;font-size: 30px; text-align: center;">ORDER</h3>
</div><br>

<div class="container-fluid">
  <form onsubmit=" return myfun()" class="form-group" action="orderdb.php"  name="form1" method="post" name="insertform" enctype="multipart/form-data">
<label class="left">Doctor Name</label>
<input type="text" name="cjob"  class="form-control" required  placeholder="Enter your name" maxlength="6"><br><br>
...
<textarea rows="4" cols="50" name="mname" required class="form-control upload"  placeholder="Pleaase lodge your complaint in about 4000 words "></textarea><br>
...
<footer class="container-fluid1 bg-4 text-center " style="overflow:auto;  border-radius: 8px;">
  ...
  <a class="navbar-brand"><img src="SRMlogo.jpg"></a>
  <p style="color:white;">2021 <a href="home.php" style="text-decoration:none ;color: lightgreen;">SHARDA MEDICAL</a>. ALL Rights Reserved.<br>Site Designed & Hosted By MR.VED</p></div>
