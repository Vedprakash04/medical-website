  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="contact.php">ContactAs</a>
        </li>
        <li class="nav-item">
...
<div class="container-fluid1 mt-3 ">
  <h3 style="color: white; padding:5px ;font-size: 30px; text-align: center;">STORE LOCATION OF SHARDA MEDICAL</h3>
</div>
<div class="side-noti">
...
<div style="padding:20px">
    ...
    <p style="    text-align: center;">Durga Chowk, Rawabhata<br>Transport Nagar, Bhanpuri<br> Raipur<br>Chhattisgarh 493221<br>
    ...
    text-decoration: none;
        background-color: transparent;
            "href="contact.php">24X7 on your Service</a>
                  </div>
