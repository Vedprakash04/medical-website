...
<div class="container-fluid1 mt-3 ">
  <h3 style="color: white; padding:5px ;font-size: 30px; text-align: center;">SERVICE BY SHARDA MEDICAL</h3>
</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="about-us-text">
                  ...
                  <ul>
                    <li>All emergency & life saving medicine available</li>
                    <li>Ayurvedic & Herbal products also available</li>
                    <li>All surgical equipments available</li>
                    <li>Available all types of medicine; if the medicines are not available in the city we will try to arrange the medicines for the customer as soon as possible.</li>
                    <li>The staff members are well qualified and are in tune with the intricacies of the task of handling prescription details and then dispensing with the right Medical product. This lies true even in case of rare and costly medicines. In the end, many a customer has gone back happy and contented. </li>
                    <li>We are specialised in all kinds of ANTICANCER,HIV-AIDS medicine</li>
                    <li>Our Shop is open from 08:00 AM to 10:30 PM for walk-in customers.</li>
                    <li>Sunday Open</li>
                    <li>We provide medicines only on prescription basis.</li>
                    
                    <li>We accept all banks credit & debit cards, cheques.</li>
                    
                    <li>Medicine delivered to the customer at the counter within minute.</li>
