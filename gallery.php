...
<div class="container-fluid1 mt-3 ">
  <h3 style="color: white; padding:5px ;font-size: 30px; text-align: center;">IMAGES OF SHARDA MEDICAL</h3>
</div><br><br>
...
<div class="side-noti">
  ...
  <div class="gallery">
    <a target="_blank" href="vv1.jpeg">
      <img src="vv1.jpeg" alt="Cinque Terre" width="600" height="400"style="display:inline;border-style: outset;border-radius: 10px;border-color: white;">
    </a>
   </div>
</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" href="vv2.jpeg">
      <img src="vv2.jpeg" alt="Forest" width="600" height="400"style="display:inline;border-style: outset;border-radius: 10px;border-color: white;">
    </a>
   </div> 
</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" href="vv3.jpeg">
      <img src="vv3.jpeg" alt="Northern Lights" width="600" height="400"style="display:inline;border-style: outset;border-radius: 10px;border-color: white;">
    </a>
   </div>
</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" href="vv3.jpg">
      <img src="vv3.jpeg" alt="Mountains" width="600" height="400"style="display:inline;border-style: outset;border-radius: 10px;border-color: white;">
    </a>
